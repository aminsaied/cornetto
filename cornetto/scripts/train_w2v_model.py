#!/usr/bin/env python3
"""Script training a word-to-vec model from a pre-processed arxiv dataset.

Such a pre-processed dataset is constructed by running the
'repeat_arxiv_data.py' script.
"""
import sys, os
