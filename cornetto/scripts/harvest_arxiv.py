"""
This script collects the data from arxiv.org. Collects metadata of all 
the papers published between two given days 
(both days given as YYYY-MM-DD strings). The metadata we collect is:
  ...
  -- 'MSCs' , string of 5-character codes, separated by a delimiter. These 
  codes are given by the standart classification of math subjects, 
  see https://zbmath.org/classification/
  -- 'Abstract' , short description of the content of the paper

The data is saved as pandas DataFrame, 
by default into the folder '../data/arxiv/'
"""
